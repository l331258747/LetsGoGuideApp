package com.njz.letsgoappguides.ui.im.cache;
...
import com.njz.letsgoappguides.http.RetrofitApiService;
...
//
//                    save("u_"+datas.getUserId(),datas.getNickname(),datas.getImgUrl());
//                }
//
//                @Override
...
//                }
//            };
//            MethodApi.getUserByIMUsername(userId, new ProgressSubscriber(listener));
//        }
