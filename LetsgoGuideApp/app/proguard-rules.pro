...
#-keep public class com.njz.letsgoappguides.model.** {
#    public void set*(***);
#    public *** get*();
#    public *** is*();
#}
-keep public class com.njz.letsgoappguides.model.** { *; }
-keep public class com.njz.letsgoappguides.ui.im** { *; }
...
-dontoptimize
#不混淆某个类的构造方法
-keepclassmembers class com.njz.letsgoappguides.Myapp {
    public <init>();
}
...
-keep public class com.njz.letsgoappguides.R$*{
