...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public static final int ITEM_SEND_SERVER = 3;

    protected int[] itemStrings = { R.string.attach_take_pic, R.string.attach_picture,R.string.attach_send_server};
    protected int[] itemdrawables = { R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,R.drawable.like__easyico };
    protected int[] itemIds = { ITEM_TAKE_PICTURE, ITEM_PICTURE,ITEM_SEND_SERVER};
