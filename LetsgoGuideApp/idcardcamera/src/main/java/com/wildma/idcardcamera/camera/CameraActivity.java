...
public class CameraActivity extends Activity implements View.OnClickListener {
    ...
    public static int      nums=0;//随机数，让返回的值不同
            ...
            public void onFinish(Bitmap bitmap) {
                ...
                if (FileUtils.createOrExistsDir(Constant.DIR_ROOT)) {
                    ...
                    if (mType == TYPE_IDCARD_FRONT) {
                        imagePath = buffer.append(Constant.DIR_ROOT).append(nums+"idCardFront.jpg").toString();
                    } else if (mType == TYPE_IDCARD_BACK) {
                        imagePath = buffer.append(Constant.DIR_ROOT).append(nums+"idCardBack.jpg").toString();
                    } else if (mType == TYPE_IDCARD_PERSON) {
                        imagePath = buffer.append(Constant.DIR_ROOT).append(nums+"idCardPerson.jpg").toString();
                    }
